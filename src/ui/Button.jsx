...
function Button({ children, disabled, to, type, clickHandler: onClick }) {
  ...
  const styles = {
    ...
    danger:
      'inline-block text-sm rounded-full bg-red-700  font-semibold uppercase tracking-wide text-stone-100 transition-colors duration-300 hover:bg-red-500    focus:bg-red-300  focus:outline-none focus:ring focus:ring-red-300    focus:ring-offset-2 disabled:cursor-not-allowed px-4 py-2 md:px-5 md:py-2.5 text-xs ',
  };
